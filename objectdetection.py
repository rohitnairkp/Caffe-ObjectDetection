...
"""Python Script that utilises Caffe Model for Object Detection.
...
def argparser():
    """Method to add argumnt functionality for command line."""
    # construct the argument parse and parse the arguments
    ap = argparse.ArgumentParser()
    ap.add_argument("-p", "--prototxt", dest='prototxt',
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # to have a maximum width of 768 pixels
        frame = vs.read()
